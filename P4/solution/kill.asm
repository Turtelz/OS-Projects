 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 9c 0b 00 00 	movzbl 0xb9c(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 44 0b 00 00 	jmp    *0xb44(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 3c 0b 00 00       	mov    $0xb3c,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 8c 11 00 00       	mov    0x118c,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 8c 11 00 00    	mov    %edx,0x118c
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 8c 11 00 00    	mov    %edx,0x118c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d 8c 11 00 00    	mov    0x118c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d 8c 11 00 00    	mov    0x118c,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 8c 11 00 00    	mov    0x118c,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 8c 11 00 00    	mov    %edx,0x118c
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 8c 11 00 00 90 	movl   $0x1190,0x118c
 727:	11 00 00 
    base.s.size = 0;
 72a:	bf 90 11 00 00       	mov    $0x1190,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 90 11 00 00 90 	movl   $0x1190,0x1190
 736:	11 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 94 11 00 00 00 	movl   $0x0,0x1194
 742:	00 00 00 
    if(p->s.size >= nunits){
...
void va_exists(struct pgdirinfo *info, uint va, int expected) {
 ...
 b08:	ba 0b 0c 00 00       	mov    $0xc0b,%edx
 b0d:	b8 0f 0c 00 00       	mov    $0xc0f,%eax
 b12:	0f 44 c2             	cmove  %edx,%eax
 b15:	50                   	push   %eax
 b16:	53                   	push   %ebx
 b17:	68 50 0d 00 00       	push   $0xd50
 b1c:	6a 01                	push   $0x1
