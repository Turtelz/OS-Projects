 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 dc 0b 00 00 	movzbl 0xbdc(%edx),%edx
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 84 0b 00 00 	jmp    *0xb84(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba 7b 0b 00 00       	mov    $0xb7b,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 cc 11 00 00       	mov    0x11cc,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 cc 11 00 00    	mov    %edx,0x11cc
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 cc 11 00 00    	mov    %edx,0x11cc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d cc 11 00 00    	mov    0x11cc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d cc 11 00 00    	mov    0x11cc,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 cc 11 00 00    	mov    0x11cc,%edx
 ...
 72c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 72f:	89 15 cc 11 00 00    	mov    %edx,0x11cc
}
 ...
 73f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 cc 11 00 00 d0 	movl   $0x11d0,0x11cc
 747:	11 00 00 
    base.s.size = 0;
 74a:	bf d0 11 00 00       	mov    $0x11d0,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 d0 11 00 00 d0 	movl   $0x11d0,0x11d0
 756:	11 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 d4 11 00 00 00 	movl   $0x0,0x11d4
 762:	00 00 00 
    if(p->s.size >= nunits){
...
void va_exists(struct pgdirinfo *info, uint va, int expected) {
 ...
 b28:	ba 4b 0c 00 00       	mov    $0xc4b,%edx
 b2d:	b8 4f 0c 00 00       	mov    $0xc4f,%eax
 b32:	0f 44 c2             	cmove  %edx,%eax
 b35:	50                   	push   %eax
 b36:	53                   	push   %ebx
 b37:	68 90 0d 00 00       	push   $0xd90
 b3c:	6a 01                	push   $0x1
